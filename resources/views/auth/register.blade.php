...
<div class="container" style="height: 100vh; display: flex;">
    <main class="form-signin" style="width: 450px; text-align: center; margin: auto;">
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-floating" style="margin-top: 15px"> <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Name">
            ...
            <button class="w-100 btn btn-lg btn-primary" style="margin-bottom: 10px; margin-top: 20px;" type="submit">Register</button>

            <div style="margin-top: 10px"><span>Already have an account? </span><a href="/login">Log in </a></div>
