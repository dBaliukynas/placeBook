@extends('layouts.app')
<title>placeBook - Log in</title>
@section('content')
<div class="container" style="height: 100vh; display: flex;">
    <main class="form-signin" style="max-width: 300px; text-align: center; margin: auto;">
        <form method="POST" action="{{ route('login') }}">
            @csrf
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 872 872" height="150" width="150" fill="#222222f0">
            ...
            <div class="form-floating">
                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" style="margin-bottom: 10px; margin-top: 20px" placeholder="Password" name="password" required autocomplete="current-password">
            ...
            <button class="w-100 btn btn-lg btn-primary" style="margin-bottom: 10px" type="submit">Log in</button>
